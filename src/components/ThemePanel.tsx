...
export function ThemePanel() {
  const {
    ...
    = useTheme() const {
      ...
      = useColorScheme() return (<Card className="w-full"> <CardHeader> <CardTitle>个性化主题设置</CardTitle> <CardDescription>选择您喜欢的明暗模式和颜色主题</CardDescription> </CardHeader> <CardContent className="space-y-6"> <div> <h3 className="text-lg font-medium mb-3">明暗模式</h3> <div className="flex flex-wrap gap-3"> <Button onClick={
        () => setTheme("light")
      }
